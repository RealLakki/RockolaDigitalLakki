...
const URBAN_ARTISTS = new Set([
  ...
  'bad gyal', 'w sound', 'kapo', 'lyanno', 'dei v', 'luar la l',
...
async function validateQueueRequest(venue, track) {
  ...
  // Forma minima del track. Sin esto se puede encolar cualquier objeto: la TV
  // acaba llamando load(undefined) y se queda en negro hasta que el watchdog
  // de stuck la salta. Ademas, un track sin titulo deja al guard de genero sin
