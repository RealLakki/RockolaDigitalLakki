...
export function SongResult({ track, disabled, disabledReason, onAdd }: Props) {
  ...
  const handleAdd = async () => {
    ...
    if (cardRef.current) {
      gsap.timeline()
        .to(cardRef.current, {
          borderColor: 'rgba(232,184,0,0.8)',
          boxShadow: '0 0 22px rgba(232,184,0,0.5)',
          duration: 0.18, ease: 'power2.out',
        })
        .to(cardRef.current, {
          borderColor: 'rgba(232,184,0,0.18)',
          boxShadow: '0 0 0px rgba(232,184,0,0)',
  ...
  return (
    <div
      ...
      style={{ border: '1px solid rgba(232,184,0,0.18)' }}
    >
